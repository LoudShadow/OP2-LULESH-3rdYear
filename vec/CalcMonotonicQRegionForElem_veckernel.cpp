  ...
  if (exec_size >0) {
    ...
    for ( int n=0; n<(exec_size/SIMD_VEC)*SIMD_VEC; n+=SIMD_VEC ){
      ...
      for ( int i=0; i<SIMD_VEC; i++ ){
        ...
        int idx3_1 = 1 * arg3.map_data[(n+i) * arg3.map->dim + 0];
        int idx4_1 = 1 * arg4.map_data[(n+i) * arg4.map->dim + 0];
        int idx5_1 = 1 * arg5.map_data[(n+i) * arg5.map->dim + 0];
        int idx6_1 = 1 * arg6.map_data[(n+i) * arg6.map->dim + 0];
        int idx7_1 = 1 * arg7.map_data[(n+i) * arg7.map->dim + 0];
        int idx8_1 = 1 * arg8.map_data[(n+i) * arg8.map->dim + 0];
        int idx9_1 = 1 * arg9.map_data[(n+i) * arg9.map->dim + 0];
        int idx10_1 = 1 * arg10.map_data[(n+i) * arg10.map->dim + 0];
        int idx11_1 = 1 * arg11.map_data[(n+i) * arg11.map->dim + 0];
        int idx12_1 = 1 * arg12.map_data[(n+i) * arg12.map->dim + 0];
        int idx13_1 = 1 * arg13.map_data[(n+i) * arg13.map->dim + 0];
        int idx14_1 = 1 * arg14.map_data[(n+i) * arg14.map->dim + 0];
        int idx15_1 = 1 * arg15.map_data[(n+i) * arg15.map->dim + 0];
        int idx16_1 = 1 * arg16.map_data[(n+i) * arg16.map->dim + 0];
        int idx17_1 = 1 * arg17.map_data[(n+i) * arg17.map->dim + 0];
        int idx18_1 = 1 * arg18.map_data[(n+i) * arg18.map->dim + 0];
