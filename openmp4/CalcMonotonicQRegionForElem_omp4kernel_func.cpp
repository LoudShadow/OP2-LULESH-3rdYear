...
void CalcMonotonicQRegionForElem_omp4_kernel(
  ...
  #pragma omp target teams num_teams(num_teams) thread_limit(nthread)  \
    ...
    map(to:col_reord[0:set_size1],map0[0:map0size],map1[0:map1size],map2[0:map2size],map4[0:map4size],map5[0:map5size],map7[0:map7size],map8[0:map8size],data0[0:dat0size],data1[0:dat1size],data2[0:dat2size],data3[0:dat3size],data4[0:dat4size],data5[0:dat5size],data6[0:dat6size],data7[0:dat7size],data8[0:dat8size],data9[0:dat9size],data10[0:dat10size],data11[0:dat11size],data12[0:dat12size],data13[0:dat13size],data14[0:dat14size],data15[0:dat15size],data16[0:dat16size],data17[0:dat17size],data18[0:dat18size])
  ...
  for ( int e=start; e<end; e++ ){
    ...
    //variable mapping
    const double *delv_xi = &data0[1 * map0idx];
    const double *delv_xi_lxim = &data1[1 * map1idx];
    const double *delv_xi_lxip = &data2[1 * map2idx];
    const double *delv_eta = &data3[1 * map0idx];
    const double *delv_eta_letam = &data4[1 * map4idx];
    const double *delv_eta_letap = &data5[1 * map5idx];
    const double *delv_zeta = &data6[1 * map0idx];
    const double *delv_zeta_lzetam = &data7[1 * map7idx];
    const double *delv_zeta_lzetap = &data8[1 * map8idx];
    const double *delx_xi = &data9[1 * map0idx];
    const double *delx_eta = &data10[1 * map0idx];
    const double *delx_zeta = &data11[1 * map0idx];
    const int *elemBC = &data12[1 * map0idx];
    const double *m_vdov = &data13[1 * map0idx];
    double *qq = &data14[1 * map0idx];
    double *ql = &data15[1 * map0idx];
    const double *elemMass = &data16[1 * map0idx];
    const double *volo = &data17[1 * map0idx];
    const double *vnew = &data18[1 * map0idx];
