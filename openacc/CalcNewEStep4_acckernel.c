...
//user function
//#pragma acc routine
inline void CalcNewEStep4_openacc( const double *delvc, const double *pbvc, double *e_new, const double *vnewc, const double *bvc, const double *p_new,
