...
void op_par_loop_CalcMonotonicQRegionForElem(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      #pragma acc parallel loop independent deviceptr(col_reord,map1,map2,map4,map5,map7,map8,data0,data3,data6,data9,data10,data11,data12,data13,data14,data15,data16,data17,data18,data1,data2,data4,data5,data7,data8)
