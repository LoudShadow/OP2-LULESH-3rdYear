...
//user function
__device__ void CalcHalfSteps_gpu( double *compression, const double *vnewc, const double* delvc, double *compHalfStep) {
    double vchalf ;
...
__global__ void op_cuda_CalcHalfSteps(
  double *arg0,
...
void op_par_loop_CalcHalfSteps(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_CalcHalfSteps<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
