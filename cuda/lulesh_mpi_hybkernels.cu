...
#define op_par_loop_CalcSpeed op_par_loop_CalcSpeed_gpu
#include "lulesh_mpi_kernels.cu"
...
#define op_par_loop_CalcSpeed op_par_loop_CalcSpeed_cpu
#include "../openmp/lulesh_mpi_kernels.cpp"
#undef op_par_loop_initStressTerms
#undef op_par_loop_IntegrateStressForElemsLoop
#undef op_par_loop_FBHourglassForceForElems
#undef op_par_loop_CalcVolumeDerivatives
...
void op_par_loop_CalcSpeed_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3);
...
void op_par_loop_CalcSpeed(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_CalcSpeed_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3);
    ...
    op_par_loop_CalcSpeed_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3);
