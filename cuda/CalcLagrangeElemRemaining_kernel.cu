...
//user function
__device__ void CalcLagrangeElemRemaining_gpu( 
...
__global__ void op_cuda_CalcLagrangeElemRemaining(
  double *arg0,
  double *arg1,
  double *arg2,
  double *arg3,
  ...
  for ( int n=threadIdx.x+blockIdx.x*blockDim.x; n<set_size; n+=blockDim.x*gridDim.x ){
    ...
    CalcLagrangeElemRemaining_gpu(arg0+n*1,
                              arg1+n*1,
                              arg2+n*1,
                              arg3+n*1,
                              arg4+n*1);
...
void op_par_loop_CalcLagrangeElemRemaining(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_CalcLagrangeElemRemaining<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
