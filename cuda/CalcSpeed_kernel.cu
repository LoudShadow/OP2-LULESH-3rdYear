...
//user function
__device__ void CalcSpeed_gpu( double *speed, const double *xd, const double *yd, const double *zd) {
...
__global__ void op_cuda_CalcSpeed(
  double *arg0,
...
void op_par_loop_CalcSpeed(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_CalcSpeed<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
