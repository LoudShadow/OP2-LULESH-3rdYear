...
//user function
__device__ void CalcQNew_gpu( const double *delvc, const double *pbvc, const double *e_new, const double *vnewc, const double *bvc, const double *p_new,
    ...
    if ( delvc[0] <= double(0.) ) {
        ...
        if (fabs(q_new[0]) < m_q_cut_cuda) q_new[0] = double(0.) ;
    }

}

// CUDA kernel function
__global__ void op_cuda_CalcQNew(
...
void op_par_loop_CalcQNew(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_CalcQNew<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
