...
//user function
__device__ void CalcPNew_gpu( double *p_new, const double *bvc, const double *e_old, const double *vnewc) {
...
__global__ void op_cuda_CalcPNew(
  double *arg0,
...
void op_par_loop_CalcPNew(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_CalcPNew<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
